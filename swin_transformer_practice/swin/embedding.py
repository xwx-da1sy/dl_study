"""把 CIFAR-100 图片转换为保留二维网格的 Patch tokens。"""
...
class PatchEmbedding(nn.Module):
    """使用不重叠卷积把 B x 3 x 32 x 32 转为 B x 16 x 16 x 96。"""
    ...
    def __init__(
        ...
        # kernel_size=stride=2：每个 2 x 2 区域成为一个互不重叠的 Patch。
        # Conv2d 输出 B x 96 x 16 x 16。
